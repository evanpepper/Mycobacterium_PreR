...
```{r}
write_csv(table.s1, file = '../supplementary-tables/Supplementary-Data-1-raw.csv')
```
...
# importing CRISPRi gene enrichment/depletion data from Supplementary Data 2
...
```{r}
write_csv(all.tests.summary, file = '../supplementary-tables/Supplementary-Data-2-raw.csv')
```
