...
```{r}
# creating figure for relative fitness vs ic50 fold change for all strains assayed, supplementary figure
...
```{r}
# generating figure
pdf(file = '../supplementary-figures/figure-panels/fig3.pdf', height = 8, width = 14)
