...
**Important note: to run notebook, user's computer must have ≥ 12.0 GB memory**
...
# importing CRISPRi gene enrichment/depletion data from Published data
...
```{r}
# write out file
write_csv(crispri.enrichment.tests.filtered, file = '../data/Fig6/crispri-enrichment-tests-filtered.csv')
```
...
crispri.data <- readxl::read_excel(path = '../data/published-data/li-et-al-2022-table-SD-F1.xlsx', sheet = 13)
