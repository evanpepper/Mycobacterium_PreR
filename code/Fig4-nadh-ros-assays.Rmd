...
nadh.nad.boxes
```
Generating plots for supplementary figure for NAD+, NADH, and NADH/NAD+ ratios
```{r}
# creating figures
...
```{r}
# generating figure
pdf(file = '../supplementary-figures/figure-panels/fig2-panel-a-points.pdf', height = 4.5, width = 4)
print(nad.points)
dev.off()

pdf(file = '../supplementary-figures/figure-panels/fig2-panel-b-points.pdf', height = 4.5, width = 4)
print(nadh.points)
dev.off()

pdf(file = '../supplementary-figures/figure-panels/fig2-panel-c-points.pdf', height = 4.5, width = 4)
print(nadh.nad.points)
dev.off()
```
...
```{r}
# generating figures
pdf(file = '../supplementary-figures/figure-panels/fig2-panel-a-boxes.pdf', height = 4.5, width = 4)
print(nad.boxes)
dev.off()

pdf(file = '../supplementary-figures/figure-panels/fig2-panel-b-boxes.pdf', height = 4.5, width = 4)
print(nadh.boxes)
dev.off()

pdf(file = '../supplementary-figures/figure-panels/fig2-panel-c-boxes.pdf', height = 4.5, width = 4)
print(nadh.nad.boxes)
dev.off()
```
...
```{r}
# generating figure
pdf(file = '../supplementary-figures/figure-panels/fig4.pdf', height = 5, width = 12)
